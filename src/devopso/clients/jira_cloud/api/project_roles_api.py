...
class ProjectRolesApi:
    ...
    def delete_project_role(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the project role to delete. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.")],
    ...
    def _delete_project_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/api/2/role/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fully_update_project_role(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the project role. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.")],
        create_update_role_request_bean: CreateUpdateRoleRequestBean,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_project_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/2/project/{projectIdOrKey}/role/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_project_role_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/2/project/{projectIdOrKey}/roledetails',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_project_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/2/project/{projectIdOrKey}/role',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
