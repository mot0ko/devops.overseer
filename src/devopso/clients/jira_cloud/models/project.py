...
class Project(BaseModel):
    ...
    roles: Optional[Dict[str, StrictStr]] = Field(default=None, description="The name and self URL for each role defined in the project. For more information, see [Create project role](#api-rest-api-2-role-post).")
    ...
    versions: Optional[List[Version]] = Field(default=None, description="The versions defined in the project. For more information, see [Create version](#api-rest-api-2-version-post).")
