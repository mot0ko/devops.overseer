...
class PermissionSchemesApi:
    ...
    def _create_permission_grant_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/api/2/permissionscheme/{schemeId}/permission',
    ...
    def _create_permission_scheme_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/api/2/permissionscheme',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_permission_scheme_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/api/2/permissionscheme/{schemeId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_permission_scheme_entity_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/api/2/permissionscheme/{schemeId}/permission/{permissionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
