...
class ProjectRoleActorsUpdateBean(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="The ID of the project role. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role IDs.")
