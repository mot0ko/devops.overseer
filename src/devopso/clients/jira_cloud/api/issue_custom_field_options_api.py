...
class IssueCustomFieldOptionsApi:
    ...
    def _create_custom_field_option_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/api/2/field/{fieldId}/context/{contextId}/option',
    ...
    def _delete_custom_field_option_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/api/2/field/{fieldId}/context/{contextId}/option/{optionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_custom_field_option_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/2/customFieldOption/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _reorder_custom_field_options_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/rest/api/2/field/{fieldId}/context/{contextId}/option/move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _replace_custom_field_option_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/api/2/field/{fieldId}/context/{contextId}/option/{optionId}/issue',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
