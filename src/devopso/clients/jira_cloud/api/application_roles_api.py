...
class ApplicationRolesApi:
    ...
    def _get_all_application_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/2/applicationrole',
    ...
    def get_application_role(
        self,
        key: Annotated[StrictStr, Field(description="The key of the application role. Use the [Get all application roles](#api-rest-api-2-applicationrole-get) operation to get the key for each application role.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_application_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/2/applicationrole/{key}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
